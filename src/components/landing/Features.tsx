...
const features = [
  {
    ...
    description:
      "Deixe o Vempreender conversar e tirar dúvidas dos seus clientes. Você foca no que realmente importa, que é o seu trabalho. E retorna o contato no seu tempo.",
  },
  {
