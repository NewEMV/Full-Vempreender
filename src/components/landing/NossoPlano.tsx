...
const plansData = [
  ...
  },
  {
    ...
    description: "Nossa Promoção é simples. Baixe e publique nosso post no Stories do seu Instagram marcando o @ai.vempreender e ganhe 50% de desconto na implantação.",
