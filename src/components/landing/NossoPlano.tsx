...
const plansData = [
  {
    ...
    description: "Nossos concorrentes tem produtos interessantes, geralmente integrando diversas ferramentas que são muito úteis, mas que nem todo pequeno empreendedor tem tempo ou habilidade para utilizar. Você paga por soluções que não consegue usar.",
  ...
  },
  {
    ...
    description: "Nossa Promoção é muito simples. Baixe e publique nosso post no Stories do seu Instagram marcando o @ai.vempreender e ganhe 50% de desconto no valor da implantação. Baixe o post durante a criação do seu chatbot.",
      ...
      <div className="container relative mx-auto px-4 md:px-24">
        ...
        <div className="mx-auto mt-8 max-w-2xl text-center">
          <p className="text-xl font-medium text-primary">
            Vempreender será seu melhor funcionário por uma fração do salário de um atendente humano. Não esquece as suas instruções, não falta e trabalha inclusive enquanto você aproveita as suas férias!
          </p>
        </div>
