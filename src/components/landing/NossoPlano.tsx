...
const plansData = [
  ...
  },
  {
    ...
    description: "Nossa Promoção é simples. Baixe e publique nosso post no Stories do seu Instagram marcando o @vempreender.ia e ganhe 50% de desconto na implantação.",
    ...
    <section id="nosso-plano" className="relative pb-5 md:pb-8">
      ...
      <div className="container relative mx-auto px-4 md:px-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-10 text-xl font-normal text-foreground sm:text-2xl">
